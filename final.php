...
<div class="container-fluid bg-2 text-center">
  <h3 class="margin">Wednesday March 22, 2017</h3>
  <p>
	Selected Bet<br />
	7:00 PM ET<br />
	Team 1 vs Team 2<br />
	Team 1 +3.5 (-115)<br />
	<br />
	Available Balance <span class="glyphicon glyphicon-link"></span> 560<br />
	<br />
	Amount to bet: 
	<br />
	<form>
	  <input type="number" name="quantity" min="1" max="560">
	</form>
	
  </p>
  <a href="confirm.php" class="btn btn-default btn-lg">
    <span class="glyphicon glyphicon-link"></span> Place Bet
  </a>
  <br />
  <br />
  <br />
